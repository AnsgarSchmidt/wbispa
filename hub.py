...
class TasksThread(threading.Thread):
    ...
    def run(self):
        ...
        api = twitter.Api(consumer_key='M6VHvhNpXOSuFHT0dFwQ',
            consumer_secret='3vji5YgYXDU4sFYAf0kU7HaZwf3cMsXWQPcLYWRAY',
            access_token_key='995619222-I4dvj9BCTgcvBzvrfANk3ClT1ooqoAkVY0KXysQU',
            access_token_secret='xYQbcQcovlc16OkrFKK6794guhMfwfEVtMZFAIVA')
